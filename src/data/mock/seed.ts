...
export const seedBusinesses: Business[] = [
  ...
  // ── Shops ──────────────────────────────────────────────────
  {
    ...
    // Filed the way the goods library files them (domain/goods.ts) — shelf,
    // kind, brand and the specs — so the business page groups this shop's
    // stock shelf by shelf the way its services already group.
    products: [
      {
        name: 'Voltas 1.5 Ton Split Air conditioner',
        price: '₹34,990',
        description: 'Copper coil, 10-yr compressor warranty',
        category: 'Home electronics',
        subcategory: 'Air conditioner',
        brand: 'Voltas',
        variants: ['1.5 Ton', 'Split', '5 Star'],
      },
      {
        name: 'Whirlpool 260 L Double door Refrigerator',
        price: '₹24,500',
        category: 'Home electronics',
        subcategory: 'Refrigerator',
        brand: 'Whirlpool',
        variants: ['260 L', 'Double door'],
      },
      {
        name: 'Symphony 75 L Desert Air cooler',
        price: '₹7,499',
        category: 'Home electronics',
        subcategory: 'Air cooler',
        brand: 'Symphony',
        variants: ['75 L', 'Desert'],
      },
      {
        name: 'Havells 15 L Storage Geyser',
        price: '₹6,999',
        category: 'Home electronics',
        subcategory: 'Geyser / water heater',
        brand: 'Havells',
        variants: ['15 L', 'Storage'],
      },
      {
        ...
        subcategory: 'Fan',
        brand: 'Crompton',
        variants: ['Ceiling', '1200 mm'],
      },
      {
        name: 'Bajaj 750 W Mixer grinder',
        price: '₹2,899',
        category: 'Kitchen appliances',
        subcategory: 'Mixer grinder',
        brand: 'Bajaj',
        variants: ['750 W', '3 jar'],
      },
      {
        name: 'Polycab 1.5 sq mm Wires & cables',
        price: '₹1,899',
        description: '90 m coil, FR copper',
        category: 'Hardware & building',
        subcategory: 'Wires & cables',
        brand: 'Polycab',
        variants: ['1.5 sq mm', '90 m coil'],
      },
      {
        ...
        brand: 'Anchor',
        variants: ['Extension board'],
      },
      {
        name: 'Havells LED bulb 9 W',
        price: '₹99',
        category: 'Home & cleaning',
        subcategory: 'Lighting & lamps',
        brand: 'Havells',
        variants: ['LED bulb 9 W'],
      },
      {
        name: 'Mosquito bat (rechargeable)',
        price: '₹399',
        category: 'Home & cleaning',
        subcategory: 'Mosquito & pest',
      },
    ],
    services: [
